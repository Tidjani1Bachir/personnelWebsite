...
export const projects = [
  ...
  {
    id: 5,
    title: "An online Buissness prototype",
    titleArab:"نموذج أعمال عبر الإنترنت",
    titleFrench:"Prototype d'entreprise en ligne",
  ...
  
  {
    ...
    des: "A Next.js template leveraging Mux for video hosting. I can create a custom Next.js app to showcase your videos.",
  ...
  },
  {
    ...
    titleArab:"متجر الكتب",
    titleFrench:"shop de Librairie",
    des: "a modern Next js app for a building Company  ",
    desArab:"تطبيق Next js حديث للبحث عن خدمات الكتب",
    desFrecnh:"Une application Next.js moderne pour trouver des services de livres",
    img: "./buildingCompanyT.png",
    
    link: "https://tidjani1bachir.github.io/construction-company-website/",
  },
  {
    id: 9,
    title: "Hang man game",
    ...
    des: "Vanilla JavaScript game utilizing a popup library and fetching data from a JSON file. ",
  ...
  },
  {
    ...
    titleArab:"نموذخ 3",
    titleFrench:"Modèle 3",
    des: "Template 3 is a comprehensive design implementation featuring essential web application components. It includes sections for payments, testimonials, hero content, landing page, team, contact information, videos, services, team members, events, a scroll-to-top button, and a customizable mega menu for efficient navigation. Advanced CSS animations enhance user experience.",
  ...
  
  {
    ...
    des: "Simple Game using type Script and Next js ",
  ...
  },
  {
    ...
    titleArab:"بوندي",
    titleFrench:"Bondi",
    des: "implimentation of a simple web design using bootstrap libirary ",
  ...
  },
  {
    id: 13,
    title: "medion ",
    titleArab:"تطبيق أدوية",
    titleFrench:"Application médicaments",
    des: "A medicines app using bootstrap libirary and Jquery  ",
    desArab:"تطبيق أدوية باستخدام مكتبة Bootstrap وJquery",
    desFrecnh:"Une application de médicaments utilisant la bibliothèque Bootstrap et jQuery",
    img: "./Median--1.png",
    
    link: "https://tidjani1bachir.github.io/Medion/",
  },
  {
    id: 14,
    title: "Cake shop ",
    ...
    des: "A medicines app using bootstrap libirary and Vannila js and scss libirary for css ",
    desArab:"تطبيق للأدوية يستخدم مكتبة bootstrap   js ومكتبة css لـ scss ",
    desFrecnh:"Une application de médicaments utilisant la bibliothèque Bootstrap, Vanilla JS et la bibliothèque SCSS pour CSS",
    img: "./Cake-shope-scss.png",
    
    link: "https://tidjani1bachir.github.io/Cake-Shop/",
  },
...
export const workExperience = [
  {
    ...
    desc: "i can create Desktop Apps with java and c++ and javascript Frameworks for desktop apps like Electron js and tauri",
  ...
  },
  {
    ...
    desc: "i can create full stack Mobile applications using React native for both android and ios (cross platform) and android studio with java with fire Base or SQL Lite",
